//
//  GetUsersCommentsOperation.swift
//  VKClient
//
...
class GetUsersCommentsOperation: AsyncOperation {
    ...
    override func main() {
        ...
        request = AF.request(NewsRouter.getCommentsUsers(ownerId: ownerId, postId: postId))
