...
extension News {
    ...
    static let allPostCases =
        [
        News(imageHeaderNews: allUsers[1].avatarImage, nameAuthorNews: allUsers[1].fullName, timeNews: "Вчера в 13:53", textNews: "Всем привет", imageNews: ["news-1-1", "news-1-2", "news-1-3", "news-1-4"], countLikeNews: 25005, countCommentsNews: 15, countRepostsNews: 266, countViewsNews: 950),
